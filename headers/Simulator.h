...
public:
	...
	void show_stats()
	{
		...
		std::cout << "The average wait time for the landing queue: " << landing_queue->get_total_wait()/landing_queue->get_num_served() << std::endl;
		...
		std::cout << "The average wait time for the departure queue: " << departure_queue->get_total_wait()/departure_queue->get_num_served() << std::endl;
